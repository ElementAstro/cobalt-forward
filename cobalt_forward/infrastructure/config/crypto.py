...
class ConfigCrypto:
    ...
    def encrypt_data(self, data: Dict[str, Any]) -> bytes:
        ...
        try:
            ...
            encrypted_data: bytes = self._fernet.encrypt(
    ...
    def decrypt_data(self, encrypted_data: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                "Failed to decrypt configuration: invalid token or corrupted data")
            raise
        except Exception as e:
    ...
    def encrypt_file(self, input_file: Path, output_file: Path) -> None:
        ...
        try:
            ...
            logger.info(
                f"Configuration file encrypted: {input_file} -> {output_file}")
    ...
    def decrypt_file(self, input_file: Path, output_file: Path) -> None:
        ...
        try:
            ...
            logger.info(
                f"Configuration file decrypted: {input_file} -> {output_file}")
