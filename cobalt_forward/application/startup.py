...
class ApplicationStartup:
    ...
    async def _register_core_services(self, config: Dict[str, Any]) -> None:
        ...
        self._container.register(IEventBus, EventBus, ServiceLifetime.SINGLETON)  # type: ignore[type-abstract]
        self._container.register(IMessageBus, MessageBus, ServiceLifetime.SINGLETON)  # type: ignore[type-abstract]
        self._container.register(ICommandDispatcher, CommandDispatcher, ServiceLifetime.SINGLETON)  # type: ignore[type-abstract]
    ...
    async def _register_infrastructure_services(self, config: Dict[str, Any]) -> None:
        ...
        self._container.register(ISSHForwarder, SSHForwarder, ServiceLifetime.SINGLETON)  # type: ignore[type-abstract]

        # Upload Manager service
        self._container.register(IUploadManager, UploadManager, ServiceLifetime.SINGLETON)  # type: ignore[type-abstract]
    ...
    async def _register_client_services(self, config: Dict[str, Any]) -> None:
        ...
        logger.debug("Client services registration skipped (not implemented yet)")
    ...
    async def _register_application_services(self, config: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.debug("Application services registration completed (with warnings)")
    ...
    def _get_component_by_name(self, component_name: str) -> Optional[Any]:
        ...
        try:
            ...
            if hasattr(self._container, 'get_registrations'):
                for service_type, registration in self._container.get_registrations().items():
